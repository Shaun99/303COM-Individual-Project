<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "INSERT INTO review (review_id, recipe_id, user_id, rev_name, rev_subject, rating, rev_message) 
     ...
     if(isset($_POST['submit2'])){
        if(isset($_SESSION['user_id'])){
        $sql = "INSERT INTO saved_recipe (saved_id, recipe_id, user_id) 
                VALUES ('', $id, '".$_SESSION['user_id']."');";
            
            if($conn = mysqli_connect('localhost', 'root', '', 'cooking_corner')) {
                if(mysqli_query($conn, $sql)) {
                    
                        header ('location: recipe-post.php?id='. $_GET["id"].'');     
                        $value = true;
                }
            }
        }
            ...
            header('refresh:0.01; url=recipe-post.php?id='. $_GET["id"].'');
            exit();
        }
    }
      ...
      if(isset($_POST['submit3'])){
        if(isset($_SESSION['user_id'])){
        $sql = "INSERT INTO shopping_list (list_id, recipe_id, user_id) 
                VALUES ('', $id, '".$_SESSION['user_id']."');";
    ...
    if($conn = mysqli_connect('localhost', 'root', '', 'cooking_corner')) {
        if(isset($_SESSION['user_id'])){
            $sql = "SELECT * FROM saved_recipe WHERE recipe_id = ". $id ." AND user_id =".$_SESSION['user_id'].";";
        ...
        if($conn = mysqli_connect('localhost', 'root', '', 'cooking_corner')) {
        if(isset($_SESSION['user_id'])){
        $sql = "SELECT * FROM shopping_list WHERE recipe_id = ". $id ." AND user_id =".$_SESSION['user_id'].";";
...
<head>
    ...
    <!-- Title -->
    <title>The Cooking Corner | Recipes</title>
   ...
   <?php 
    ...
    ?>
     <?php
        ...
        if($conn = mysqli_connect('localhost', 'root', '', 'cooking_corner')) {
            $sql = "SELECT * FROM recipe,admin WHERE recipe.admin_id = admin.admin_id AND recipe_id = ". $id .";";
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-8">
                        <div class="receipe-headline my-5">
                            ...
                            <img width="40px" height="40px" style="border-radius: 100px;" src="img/core-img/'.$row['admin_profile'].'" alt="profile"/>
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        if(isset($_SESSION['user_id'])){
                        if ($numRow_saved > 0) {
                            echo'   <a href="deleteSaved2.php?saved_id='. $_GET['id'] .'&recipe_id='. $_GET['id'] .'" onclick="return confirm(\'Do you wish to remove this saved recipe?\');">
                                    <button type="button" class="saved-btn2">
                                        <b><i class="fa fa-heart"></i> Saved</b>
                                    </button>
                                    </a>';
                        } else {
                            echo'<form name="saved" action="recipe-post.php?id='. $_GET['id'] .'"  method="post">
              ...
              print'          </div>
                    ...
                    <div class="col-12 col-lg-4">
                        ...
                        if(isset($_SESSION['user_id'])){
                        if ($numRow_saved2 > 0) {
                            echo'   <a href="deleteList2.php?list_id='. $_GET['id'] .'&recipe_id='. $_GET['id'] .'" onclick="return confirm(\'Do you wish to remove this added list?\');">
               ...
               print'             </div>
                ...
                <div class="review-form-area bg-overlay3">
                    <div class="row">
                        ...
                        <form name="reviewForm" action="recipe-post.php?id='. $_GET['id'] .'"  method="post">
                            <div class="row">
                                <div class="col-12 col-lg-4">
    ...
    <h3 style="padding-left: 30px;"> Recommended for you </h3>
    <hr>
    <?php
      if($conn = mysqli_connect('localhost', 'root', '', 'cooking_corner')) {
    ...
    <div class="ft-recipe__content" >
     <img src="img/recipe-img/'.$row['re_image1'].'"><br/><br/>
        ...
        <div style="float:right;">
             <a href="recipe-post.php?id='. $row['recipe_id'] .'" class="btn manage-blog-btn mt-30">
