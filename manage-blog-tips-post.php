...
<head>
    ...
    <!-- Title -->
    <title>The Cooking Corner | Manage Tips & Advices </title>
</head>
    ...
    <div class="col-lg-12 p-l-0 title-margin-left">
         <div class="page-header">   
             <ol class="breadcrumb">
                 ...
                 <li class="breadcrumb-item active"> Manage Tips & Advices</li>
             </ol>
         </div>
     </div>
     ...
     <?php
       if(isset($_GET['msg'])) {
                echo '<div class="bg-success" style="border-radius: 5px; padding:4px 2px 0px 2px; margin: 0px 50px; margin-bottom: -40px;">';
                        echo '<p class="p-1 pl-3" style="color:#FFF;">'. $_GET['msg'] .' <a href="manage-blog-tips-post.php" class="float-right pr-3">Close</a></p>';
                echo '</div>';
        }
    ?>
                    ...
                    if($r = mysqli_query($conn,$sql)){
                            ...
                            print' <!-- Single Blog Area -->
                             <div class="single-blog-area mb-80">
                                 ...
                                 <div class="blog-thumbnail">
                                    <a href="deleteUserTips.php?tblog_id='. $row['tblog_id'] .'" onclick="return confirm(\'Are you sure you want to delete this user blog?\');">
                         ...
                         print'</b></div>
                                ...
                                print' </b>  
                                     ...
                                     <a href="manage-blog-tips-post-view.php?id='. $row['tblog_id'] .'" class="btn delicious-btn mt-30">
                    ...
                    <?php
                        ...
                        <div class="single-widget mb-80">
                            ...
                            <ul class="list">
                                ...
                                <li><a href="manage-blog-tips-post.php?blog_category=1">Restaurants</a></li>
                                <li><a href="manage-blog-tips-post.php?blog_category=2">Food &amp; Drinks</a></li>
                                <li><a href="manage-blog-tips-post.php?blog_category=3">Vegans</a></li>
                                <li><a href="manage-blog-tips-post.php?blog_category=4">Events &amp; Lifestyle</a></li>
                                <li><a href="manage-blog-tips-post.php?blog_category=5">Uncategorized</a></li>
                            </ul>
                        </div>';
