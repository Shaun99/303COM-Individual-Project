...
<head>
    ...
    <!-- Title -->
    <title>The Cooking Corner | Recipe Blog</title>
</head>
    ...
    <div class="col-lg-12 p-l-0 title-margin-left">
         <div class="page-header">   
             <ol class="breadcrumb">
                 ...
                 <li class="breadcrumb-item active">Recipe Blog</li>
             </ol>
         </div>
     </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <?php
                    ...
                    //Define thr query
                    $sql = "SELECT * FROM recipe_blog,user  WHERE recipe_blog.user_id = user.user_id ORDER BY posted_at DESC LIMIT 2 OFFSET ". ((2 * $_GET['page']) - 2);
