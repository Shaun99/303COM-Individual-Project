...
<body>
   <?php 
    include'components/nav-bar-admin-login.php'; 
    ...
    <div class="col-lg-12 p-l-0 title-margin-left">
         <div class="page-header">   
             <ol class="breadcrumb">
                 ...
                 <li class="breadcrumb-item"><a href="manage-blog-tips-post.php"> Manage Tips & Advices</a></li>
                                ...
                                print  '<div class="review-container" style="width:100%">         
                                            <div class="w3-container">
                                                <div class="row">
                                                    ...
                                                    <div class="col-3" style="color:#FFAE42;" >';
                                                        switch($row['rating']) {
                                                            case 1:
...
?>
    ...
    <div class="col-lg-4">
        <div class="more-blog-container">
            <h3 class="mt-4" style="color:#ffc13b;">Latest Blog Posted From User</h3>
    ...
    <div class="ft-recipe__content">
     <img src="img/blog-img/'.$row['rblog_image1'].'"><br/><br/>
        ...
        <div style="float:right;">
             <a href="manage-blog-tips-post-view.php?id='. $row['tblog_id'] .'" class="btn mt-30">
