                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li <?php if ($thisPage == "Page") {echo " class=\"active\"";} ?>><a href="#">Pages</a>
                                        <ul class="dropdown">
                                            <li>
                                                 ...
                                                 <ul class="dropdown">
                                                     <li>
                                                        ...
                                                        <ul class="dropdown" style="height: 100px;">
                                                            <li>
                                                                <a href="insert-blog-recipe.php">Recipe</a>
                                                            </li>     
                                                            <li>
                                                                <a href="insert-blog-tips.php">Food Tips & Advices</a>
                                                            </li>    
                                                        </ul>
                                                    </li>  
                                                     <li>
                                    ...
                                    <li <?php if ($thisPage == "Profile" || $thisPage == "MyBlog") {echo " class=\"active\"";} ?>>
                                       <?php echo' <a href="#">  ';                    
                                            ...
                                            echo
                                            '<img src="'.$image.'" style="width:40px; height:40px; border-radius: 200px;">'; 
                                        ...
                                        ?>
                                         ...
                                         <ul class="dropdown">
                                            ...
                                            <li <?php if ($thisPage == "MyBlog") {echo " class=\"active\"";} ?>>
                                                <a href="myblog.php"><i class="fa fa-th-large"></i> &nbsp; My Blog</a>
                                            </li>
                                            <li <?php if ($thisPage == "MySave") {echo " class=\"active\"";} ?>>
                                                <a href="saved-recipe.php"><i class="fa fa-heart"></i> &nbsp; My Saved Recipes</a>
                                            </li>
                                              <li <?php if ($thisPage == "MyList") {echo " class=\"active\"";} ?>>
                                                <a href="shopping-list.php"><i class="fa fa-list"></i> &nbsp; My Shopping List</a>
                                            </li>
                                            <li>
