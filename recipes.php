   ...
   <?php 
    ...
    <center>
        <nav aria-label="Page navigation example">
            ...
            <?php if ($_GET['page'] > 1): ?>
                <li><a href="<?php echo 'recipes.php?page='. ($_GET['page'] - 1); ?>">&laquo; Prev</a></li>
            <?php endif; ?>
            <?php 
            for ($i = 0; $i < COUNT_FROM_DB / LIMIT; $i++) {
                echo '&nbsp;<li ><a class="active" href="recipes.php?page='. ($i + 1) .'">'. ($i + 1) .'</a></li>';
            } 
            ?>
            <?php if ($_GET['page'] < (COUNT_FROM_DB / LIMIT)): ?>
                <li><a href="<?php echo 'recipes.php?page='. ($_GET['page'] + 1); ?>">Next &raquo;</a></li>
            <?php endif; ?>
            </div>
        </nav>
    </center>
        ...
        if($conn = mysqli_connect('localhost', 'root', '', 'cooking_corner')) {
            ...
            if($r = mysqli_query($conn,$sql)){
                ...
                while($row = mysqli_fetch_assoc($r)){
                    ...
                    $sql = "SELECT COUNT(*) AS recipe_count FROM review WHERE recipe_id = ". $row['recipe_id'];
                    $count = 0;
                ...
                print'</div>
                    ...
                    <br/>
                        ...
                        <p> By&nbsp;
                            ...
                            <b style="float:right;">'. $count .' <i class="fa fa-comment"></i></b> 
                        </p>
